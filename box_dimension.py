...
class Dimension:
    ...
    def pixel_to_camera(self, x, y, depth_frame):
        """Convert pixel coordinates to 3D camera space using depth"""
    ...
    def transform_to_gripper(self, camera_coords):
        """Convert camera coordinates to robot gripper frame (dummy for now)"""
        # Replace this with actual transformation logic if needed
